...
def get_response():
    ...
    while On == True:
        ...
        syt_prompt = "You are a checker bot, for a game anwersing a question about a game's daily jourmal log. Question: "
        question = "is this jounrnal log realistic considering the circumstance?"
        syt_prompt = syt_prompt + question
